const updateInventory = require("./inventory-update.js");
...
describe("Inventory Update", () => {
  ...
  xtest("When given 2 arrays with different items and unsorted, will return an updated inventory of items which is sorted by the item name", () => {
    const items1 = [
      [14, "figs"],
      [27, "hammers"],
      [3, "deck chairs"],
